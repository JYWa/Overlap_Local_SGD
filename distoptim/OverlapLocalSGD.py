...
class OverlapLocalSGD(Optimizer):
    ...
    def __init__(self, params, alpha, gmf, tau, size, lr=required, momentum=0, dampening=0,
        ...
        super(OverlapLocalSGD, self).__init__(params, defaults)
        ...
        self.comm_thread = threading.Thread(
                target=OverlapLocalSGD._async_all_reduce_,
    ...
    def __setstate__(self, state):
        super(OverlapLocalSGD, self).__setstate__(state)
        for group in self.param_groups:
